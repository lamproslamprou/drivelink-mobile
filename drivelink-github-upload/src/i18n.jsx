...
const dict = {
  en: {
    ...
    "lp.why.badge": "Why escrow",
    "lp.why.title": "Everything about a private sale is fine until the money moves.",
    "lp.why.buyerLabel": "The buyer's problem",
    "lp.why.buyerText": "You're about to send five figures to someone you met online, for a car you can't take with you until the title clears. If they vanish, you have a text thread and a name that might not be real.",
    "lp.why.sellerLabel": "The seller's problem",
    "lp.why.sellerText": "The cashier's check looks perfect. Cashier's checks always look perfect. You find out in ten days whether it was — and by then the car is in another state.",
    "lp.why.bothLabel": "Both of your problem",
    "lp.why.bothText": "Neither of you knows how to sign over a title. Neither of you has a bill of sale. So the deal drags, one of you gets nervous, and it dies.",
    "lp.why.close": "This is the part nobody built for. So we did.",
    "lp.byod.badge": "Bring your own deal",
    "lp.byod.title": "Already found the car? You don't need our listings.",
    "lp.byod.text": "Found it on Facebook Marketplace, Craigslist, or through a friend of a friend? Start a secure deal, send the other person a link, and DriveLink handles the money exactly the same way — held until the keys and the signed title change hands. No listing to create, nothing to browse, nobody to wait for.",
    "lp.byod.buyLabel": "If you're buying",
    "lp.byod.buyText": "Enter the car and the price you already agreed on. Send the link. Pay into escrow instead of wiring five figures to someone you met online.",
    "lp.byod.sellLabel": "If you're selling",
    "lp.byod.sellText": "Send the link before you hand over anything. You'll see the buyer's money is real and held — no cashier's check that clears in ten days, or doesn't.",
    "lp.byod.btn": "Start a secure deal →",
    "lp.byod.fine": "Takes about two minutes. 1% seller fee on completion — nothing if the deal falls through.",
    "lp.esc.badge": "How escrow works",
    "lp.esc.title": "Four steps. About ten minutes of actual work.",
    "lp.esc.t1": "Agree on the car",
    "lp.esc.d1": "Either the buyer finds a listing here and you settle on a price through offers, or you already agreed on a car somewhere else and start a secure deal with a link.",
    "lp.esc.t2": "Both sides verify",
    "lp.esc.d2": "Government ID check on both parties through Stripe Identity. You find out who you're dealing with before any money moves.",
    "lp.esc.t3": "Buyer funds escrow",
    "lp.esc.d3": "The money goes to a secured Stripe account — not to the seller, not yet. The seller can see it's there and hand over the car with confidence.",
    "lp.esc.t4": "Keys change hands, funds release",
    "lp.esc.d4": "The buyer confirms they have the car and signed title. Funds transfer to the seller, usually same day. Both of you get a receipt for the completed sale.",
    "lp.esc.fee": "**1% platform fee**, seller side, on a completed sale — 2% max if a promoter referral brought the buyer. If the deal falls apart before release, the buyer's funds return and nobody is charged.",
    "lp.assure.badge": "On every listing",
    "lp.assure.title": "You don't have to ask whether it's the safe kind of deal.",
    "lp.assure.text": "There's no premium tier and nothing to opt into. Every car on DriveLink closes the same way — the buyer's money held in escrow until the keys and title change hands. That's the only way to buy or sell here.",
    "lp.assure.btn": "Browse cars →",
    "lp.cta.title": "Ready to get started?",
    "lp.cta.sub": "Join DriveLink today — it's free to sign up.",
    "lp.cta.browse": "Browse Cars →",
    "lp.cta.create": "Create Account",
    "lp.cta.byod": "Secure a deal I found →",
    "lp.nav.secure": "🔒 Secure a Deal",
    "lp.nav.browse": "Browse Cars",
    "lp.nav.app": "Go to App →",
    "lp.nav.signin": "Sign In",
    "lp.foot.tagline": "Peer-to-peer car marketplace with escrow on every deal.",
    "lp.foot.rights": "© 2026 DriveLink. All rights reserved.",
    "lp.foot.us": "U.S. transactions only. DriveLink LLC, Branchburg, NJ.",
    "lp.foot.safety": "🛡️ Safety Tips",
    "lp.foot.terms": "Terms of Service",
    "lp.foot.privacy": "Privacy Policy",
    "lp.badge": "U.S. only \u00a0\u2022\u00a0 Escrow protected \u00a0\u2022\u00a0 Peer-to-peer",
  ...
  es: {
    ...
    "lp.why.badge": "Por qué depósito en garantía",
    "lp.why.title": "En una venta entre particulares todo va bien hasta que se mueve el dinero.",
    "lp.why.buyerLabel": "El problema del comprador",
    "lp.why.buyerText": "Estás a punto de enviar cinco cifras a alguien que conociste en internet, por un carro que no puedes llevarte hasta que salga el título. Si desaparece, te queda una conversación de mensajes y un nombre que quizá no sea real.",
    "lp.why.sellerLabel": "El problema del vendedor",
    "lp.why.sellerText": "El cheque de caja se ve perfecto. Los cheques de caja siempre se ven perfectos. Te enteras en diez días si lo era — y para entonces el carro está en otro estado.",
    "lp.why.bothLabel": "El problema de los dos",
    "lp.why.bothText": "Ninguno de los dos sabe cómo traspasar un título. Ninguno tiene un contrato de compraventa. Así que el trato se alarga, uno de los dos se pone nervioso, y se cae.",
    "lp.why.close": "Esta es la parte que nadie había resuelto. Nosotros sí.",
    "lp.byod.badge": "Trae tu propio trato",
    "lp.byod.title": "¿Ya encontraste el carro? No necesitas nuestros anuncios.",
    "lp.byod.text": "¿Lo encontraste en Facebook Marketplace, Craigslist o por un conocido? Abre un trato seguro, envía el enlace a la otra persona, y DriveLink maneja el dinero igual — retenido hasta que se entreguen las llaves y el título firmado. No hay anuncio que crear, nada que explorar, nadie a quien esperar.",
    "lp.byod.buyLabel": "Si estás comprando",
    "lp.byod.buyText": "Escribe el carro y el precio que ya acordaron. Envía el enlace. Paga al depósito en garantía en vez de transferir cinco cifras a alguien que conociste en internet.",
    "lp.byod.sellLabel": "Si estás vendiendo",
    "lp.byod.sellText": "Envía el enlace antes de entregar nada. Verás que el dinero del comprador es real y está retenido — sin cheques de caja que tardan diez días en aclararse, o que nunca lo hacen.",
    "lp.byod.btn": "Abrir un trato seguro →",
    "lp.byod.fine": "Toma unos dos minutos. 1% de comisión del vendedor al completarse — nada si el trato no se concreta.",
    "lp.esc.badge": "Cómo funciona el depósito",
    "lp.esc.title": "Cuatro pasos. Unos diez minutos de trabajo real.",
    "lp.esc.t1": "Acuerden el carro",
    "lp.esc.d1": "O el comprador encuentra un anuncio aquí y acuerdan un precio con ofertas, o ya acordaron un carro en otro lado y abren un trato seguro con un enlace.",
    "lp.esc.t2": "Ambas partes se verifican",
    "lp.esc.d2": "Verificación de identificación oficial para ambas partes con Stripe Identity. Sabes con quién estás tratando antes de que se mueva el dinero.",
    "lp.esc.t3": "El comprador deposita",
    "lp.esc.d3": "El dinero va a una cuenta segura de Stripe — no al vendedor, todavía no. El vendedor ve que está ahí y entrega el carro con confianza.",
    "lp.esc.t4": "Cambian las llaves, se libera el dinero",
    "lp.esc.d4": "El comprador confirma que tiene el carro y el título firmado. El dinero se transfiere al vendedor, normalmente el mismo día. Ambos reciben un comprobante de la venta.",
    "lp.esc.fee": "**1% de comisión de la plataforma**, del lado del vendedor, sobre una venta completada — 2% máximo si un promotor trajo al comprador. Si el trato se cae antes de liberarse, el dinero del comprador se devuelve y no se cobra nada.",
    "lp.assure.badge": "En cada anuncio",
    "lp.assure.title": "No tienes que preguntar si este es de los tratos seguros.",
    "lp.assure.text": "No hay plan premium ni nada que activar. Cada carro en DriveLink se cierra igual — el dinero del comprador retenido hasta que se entreguen las llaves y el título. Es la única forma de comprar o vender aquí.",
    "lp.assure.btn": "Ver carros →",
    "lp.cta.title": "¿Listo para empezar?",
    "lp.cta.sub": "Únete a DriveLink hoy — registrarse es gratis.",
    "lp.cta.browse": "Ver carros →",
    "lp.cta.create": "Crear cuenta",
    "lp.cta.byod": "Asegurar un trato que encontré →",
    "lp.nav.secure": "🔒 Asegurar un trato",
    "lp.nav.browse": "Ver carros",
    "lp.nav.app": "Ir a la app →",
    "lp.nav.signin": "Iniciar sesión",
    "lp.foot.tagline": "Mercado de carros entre particulares con depósito en garantía en cada trato.",
    "lp.foot.rights": "© 2026 DriveLink. Todos los derechos reservados.",
    "lp.foot.us": "Solo transacciones en EE.\u00a0UU. DriveLink LLC, Branchburg, NJ.",
    "lp.foot.safety": "🛡️ Consejos de seguridad",
    "lp.foot.terms": "Términos del servicio",
    "lp.foot.privacy": "Política de privacidad",
    "lp.badge": "Solo en EE.\u00a0UU. \u00a0\u2022\u00a0 Pago protegido \u00a0\u2022\u00a0 Entre particulares",
